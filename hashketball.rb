...
def most_points_scored
  most_points_player = all_players.max_by { |player| player[:points] }
...
def winning_team
  home_points_array =
    game_hash[:home][:players].map { |player| player[:points] }
  home_points = home_points_array.sum
  away_points_array =
    game_hash[:away][:players].map { |player| player[:points] }
  away_points = away_points_array.sum
  winner =
